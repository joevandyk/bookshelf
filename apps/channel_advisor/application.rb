...
module ChannelAdvisor
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['CHANNEL_ADVISOR_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load ChannelAdvisor::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time ChannelAdvisor::Action is included
      ...
      # Configure the code that will yield each time ChannelAdvisor::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include ChannelAdvisor::Assets::Helpers
      end
    end
